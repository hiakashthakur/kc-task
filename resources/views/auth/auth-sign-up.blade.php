...
<head>
  ...
  <body class=" ">
                              ...
                              <div class="p-3">
                                 ...
                                 <form method="POST" action="{{ route('register') }}" class="form">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" type="email" id="name" name="email"placeholder=" ">
                                             @error('email')
                                                 <div class="alert alert-danger">{{ $message }}</div>
                                             @enderror
                                             <label>Email</label>
                                       ...
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" name="number" type="number" placeholder=" ">
                                             @error('number')
                                                 <div class="alert alert-danger">{{ $message }}</div>
                                             @enderror
                                       ...
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" type="password" placeholder=" " name="password_confirmation">
    ...
    <!-- app JavaScript -->
    <script src="../assets/js/app.js"></script>4
       ...
       $("body").on("submit", ".form", function (event) {
                    ...
                    $.ajax({
                        ...
                        .done(function (data) {
                            ...
                            if (data.number) {
                                $('<span class="text-danger">' + data.number + "</span>").insertAfter($('input[name="number"]', this_));
                            }
                            if (data.password) {
                                $('<span class="text-danger">' + data.password + "</span>").insertAfter($('input[name="password"]', this_));
                            }
                            if (data.password_confirmation) {
                                $('<span class="text-danger">' + data.password_confirmation + "</span>").insertAfter($('input[name="password_confirmation"]', this_));
                            }
                            if (data.err) {
